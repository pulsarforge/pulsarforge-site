...
function CivilizationsVoxelverseCrafter(){
  return(
<>
...
<h1>Civilizations Voxelverse</h1>
<p>
**World Building**
<br/>
<br/>
...
<h2>Travel into the Voxelverse Exoplanets</h2>
<p>
...
<h4>"The civilizations fates are in your hands"</h4>
            </div>
          </div>
        </div>
        <div className="spacer" data-height="96"></div>
...
export default CivilizationsVoxelverseCrafter;